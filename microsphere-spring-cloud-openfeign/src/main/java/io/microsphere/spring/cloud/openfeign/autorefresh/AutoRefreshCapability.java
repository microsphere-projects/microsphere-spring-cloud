...
public class AutoRefreshCapability implements Capability, ApplicationContextAware {
     ...
     *     clientProperties, feignContext, componentRegistry);
     * }</pre>
     *
     ...
     * from the {@code feign.client.name} property.
     *
     * <p>Example Usage:
     * <pre>{@code
     * AutoRefreshCapability capability = new AutoRefreshCapability(props, feignContext, registry);
