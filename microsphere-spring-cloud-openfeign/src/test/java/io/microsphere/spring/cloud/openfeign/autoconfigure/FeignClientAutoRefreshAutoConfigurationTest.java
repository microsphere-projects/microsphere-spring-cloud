...
/**
 * {@link FeignClientAutoRefreshAutoConfiguration} Test
 *
...
@SpringBootTest(
        classes = {
                ...
                FeignClientAutoRefreshAutoConfigurationTest.class
        },
        webEnvironment = NONE
)
@EnableConfigurationProperties(FeignClientProperties.class)
class FeignClientAutoRefreshAutoConfigurationTest extends AutoConfigurationTest<FeignClientAutoRefreshAutoConfiguration> {

    @Override
    protected void configureAutoConfiguredClasses(Set<Class<?>> autoConfiguredClasses) {
        autoConfiguredClasses.add(FeignComponentRegistry.class);
        autoConfiguredClasses.add(AutoRefreshCapabilityCustomizer.class);
    }
    ...
    protected void configureGlobalMissingClasses(Set<Class<?>> globalMissingClasses) {
        ...
        globalMissingClasses.add(Capability.class);
        globalMissingClasses.add(FeignClientFactoryBean.class);
    }
}